...
public class PicCarousel : MonoBehaviour
{
	...
	{	
		...
		panelRect.anchoredPosition = new Vector2 (parentRect.rect.xMin + panelRect.rect.width / 2, panelRect.rect.y + panelRect.rect.height/2);//panelRect.rect.y - panelRect.rect.height);// - 5f);
